...
export const chineseAndEnglish_ = /^[a-zA-Z0-9_\u4e00-\u9fa5]+$/; // 中英文、数字、下划线

export const chineseAndEnglish_bracket = /^[a-zA-Z0-9_\u4e00-\u9fa5\(\)\（\）]+$/; // 中英文、数字、下划线、中英文的括号
...
export const patternUserName = /^([a-zA-Z0-9_-（）()]|([\u4e00-\u9fa5])){1,30}$/; //用户名显示 中英文数字 -_()（）

export const patternLoginName = /^([a-zA-Z0-9_-]|([\u4e00-\u9fa5])){1,30}$/; //用户名显示 中英文数字 -_()（）

export const patternSql = /^((?!%|#).)*$/; // 数据库敏感字符
