...
var _BaseTree = _interopRequireDefault(require('./components/BaseTree'));

var _TreeEmpty = _interopRequireDefault(require('./components/TreeEmpty'));
...
var SearchTree = function SearchTree(_ref) {
  ...
  var newTree = _objectSpread(
    {
      ...
      menuRightRender: menuRightRender,
  ...
  return /*#__PURE__*/ _react.default.createElement(
    ...
    null,
    treeData.length > 0
      ? /*#__PURE__*/ _react.default.createElement(_BaseTree.default, newTree)
      : /*#__PURE__*/ _react.default.createElement(_TreeEmpty.default, null),
  );
};
...
SearchTree.BreadCrumb = _BreadCrumb.default;
