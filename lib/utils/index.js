 ...
 * @param {*} childrenField
 */
var getDataList = function getDataList(treeData, keyField, nameField, childrenField) {
  var dataList = [];

  function generateList(data) {
    var parentNode = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    data === null || data === void 0 ? void 0 : data.forEach(function (node) {
      var key = "".concat(node[keyField]);
      var title = node[nameField];
      dataList.push(_objectSpread({
        key: key,
        title: title,
