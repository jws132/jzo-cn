...
var FormGroup = function FormGroup(props) {
  var gutter = props.gutter,
    ...
    _props$itemLayout = props.itemLayout,
    itemLayout = _props$itemLayout === void 0 ? {} : _props$itemLayout;
  ...
  var fieldRender = function fieldRender(ctx, _ref) {
    var dependency = _ref.dependency,
      ...
      restProps = _objectWithoutProperties(_ref, ['dependency', 'fieldKey']);

    var itemSet = _objectSpread({}, restProps);
    ...
    if (dependency) {
      ...
      for (var i = 0; i < deps.length; i++) {
        ...
        if ((0, _lodash.isBoolean)(dependency[type])) {
  ...
  var renderChildren = function renderChildren(props) {
    var formInstance = props.formInstance,
      fields = props.fields,
      container = props.container,
      actionsRender = props.actionsRender,
      itemLayout = props.itemLayout;
    var children = fields ? groupRender(formInstance, props) : props.children;
    var actionsElem;
