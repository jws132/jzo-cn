...
var CheckBox = function CheckBox(_ref) {
  ...
  var newRadioData = (0, _react.useMemo)(
    function() {
      return optionsData.map(function(el) {
        return {
          value: el[valueKey],
          label: el[labelKey],
        };
  ...
  var newProps = _objectSpread(
    {
      ...
      onChange: function onChange(changedValue) {
        console.log(
          'changedValue',
          changedValue,
          _toConsumableArray(value).concat(changedValue),
        );
        _onChange && _onChange(_toConsumableArray(value).concat(changedValue));
      },
    },
    restProps,
  );
